                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4 text-center space-x-2">
                                <!-- Edit Button -->
                                <a href="{{ route('kuiss.edit', $quiz->id) }}" class="inline-block bg-blue-500 hover:bg-blue-600 text-white text-xs font-medium py-2 px-4 rounded transition">
                                    Edit
                                </a>
                                <!-- Delete Button -->
                                <button onclick="openDeleteModal(event, '{{ $quiz->id }}')" class="inline-block bg-red-500 hover:bg-red-600 text-white text-xs font-medium py-2 px-4 rounded transition">
                                    Hapus
                                </button>
                            </td>
                        </tr>
